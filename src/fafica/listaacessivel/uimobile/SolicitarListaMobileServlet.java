...
/**
 * Servlet implementation class SolicitarListaMobileServlet
 */
@WebServlet("/SolicitarListaMobileServlet")
public class SolicitarListaMobileServlet extends HttpServlet {
     ...
     */
    public SolicitarListaMobileServlet() {
        super();
