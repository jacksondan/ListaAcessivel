...
/**
 * Servlet implementation class EnTransitoEntregaListaServlet
 */
@WebServlet("/EmTransitoEntregaListaServlet")
public class EmTransitoEntregaListaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 /**
     * @see HttpServlet#HttpServlet()
     */
    public EmTransitoEntregaListaServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(funcionario != null){
			try {
				...
				lista.setSituacao(SituacaoLista.EMTRANSITO.toString());
