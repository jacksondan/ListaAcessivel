...
/**
 * Servlet implementation class TestePesquisarCliente
 */
@WebServlet("/TestePesquisarCliente")
public class TestePesquisarCliente extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TestePesquisarCliente() {
        super();
