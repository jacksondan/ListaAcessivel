...
/**
 * Servlet implementation class TestePesquisarEstabelecimento
 */
@WebServlet("/TestePesquisarEstabelecimento")
public class TestePesquisarEstabelecimento extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TestePesquisarEstabelecimento() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			estabelecimento.setId_estabelecimento(2);
