...
<%@include file="sidebarEstabelecimento.html" %>
			...
			<form method="post" action="EditarProdutoServlet">
				...
				<input type="hidden"  name="id_estabelecimento" value="${editarProduto.estabelecimento.id_estabelecimento}">
				
				<fieldset >
				<legend><strong>Dados do Produto</strong></legend>
				
				<p><label for="descrição">Descrição:</label>
				<input type="text"  name="descricao" id="descrição" value="${editarProduto.descricao}"size=60></p>
				
				<p><label for="valor">Preço:</label>
